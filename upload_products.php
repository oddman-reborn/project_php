...
?>
		...
		<form action="upload_products.php" method="POST" enctype="multipart/form-data"><br>
			...
			<p> Category :	 <input type="radio" name="category" value="Dress">Dress
									 <input type="radio" name="category" value="Electronics">Electronics
									 <input type="radio" name="category" value="Books">Books
									 <input type="radio" name="category" value="Others" checked>Others
									 </p><br><br>
